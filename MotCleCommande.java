 ...
 *  le jeu. Elle est utilisable pour verifier la validite des commandes de
 *  l'utilisateur.
 *
...
public class MotCleCommande {
	 ...
	 */
	private final static String commandesValides[] = {"aller", "donner", "quitter", "jeter", "aide", "prendre", "retour", "parler"};
